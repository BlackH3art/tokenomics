...
import { tokenABIv3, tokenContractAddressV3 } from "../../contracts/contracts";
...
export const TokenV3: FC = () => {
  ...
  const { contractProvider: token } = useContractProvider(tokenContractAddressV3, tokenABIv3);
  ...
  useContractEvent({
    address: tokenContractAddressV3,
    abi: tokenABIv3,
    eventName: 'Transfer',
    listener() {
      getTokenBalances();
  ...
  return (
    <>
      <TokenStats 
        title='Snouts Token V3'
        contractAddres={tokenContractAddressV3}
        ABI={tokenABIv3}
      />
