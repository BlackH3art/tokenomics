...
import { tokenABIv4, tokenContractAddressV4 } from "../../contracts/contracts";
...
export const TokenV4: FC = () => {
  ...
  const [allocations, setAllocations] = useState<SingleAllocation[]>([
    ...
    { name:"Marketing", address: "0xc135350E38ec11Cb95aF6C1Acd106A97c95c6271", allocation: "5%", balance: "-" },
    { name:"Development", address: "0xD2508A652082533d0E9Ce1B4c1294D0e25C36CB2", allocation: "5%", balance: "-" },
    ...
    { name:"Liquidity pool", address: "0x02E96e9F8E61E5f735DEd4D386F3249ca59462E4", allocation: "10%", balance: "-" },
    { name:"Staking", address: "0xafFD814aFdE5f6F5f76A14ea0a1293627b2cFb3f", allocation: "20%", balance: "-" },
    { name:"Rewards", address: "0xD306fB799A9Fe6d857d8Ea558ba9f9d2a129adDc", allocation: "20%", balance: "-" },
    { name:"Utility rewards", address: "0x4bcF37FB9C7b491644f31A0673d42cc67e199AAB", allocation: "5%", balance: "-" },
  ]);

  const { contractProvider: token } = useContractProvider(tokenContractAddressV4, tokenABIv4);
  ...
  useContractEvent({
    address: tokenContractAddressV4,
    abi: tokenABIv4,
    eventName: 'Transfer',
    listener() {
      getTokenBalances();
  ...
  return (
    <>
      <TokenStats 
        title='Snouts Token V4'
        contractAddres={tokenContractAddressV4}
        ABI={tokenABIv4}
      />
